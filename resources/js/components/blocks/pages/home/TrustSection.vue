<template>
    <div>
        <section class="bg-gradient-to-b from-neutral-900 to-neutral-800 text-white py-20 px-6 md:px-16">
            <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-neutral-200">
                        <li class="flex items-start gap-3">
                            ...
                            <span><strong>Rapid Response:</strong> We’re ready to deploy within minutes of your
                                call.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-amber-400 text-xl">🧭</span>
                            <span><strong>Global Coverage:</strong> Operating across 30+ countries and regions.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-amber-400 text-xl">🩺</span>
                            <span><strong>Experienced Medical Crew:</strong> Certified professionals trained for
                                emergency air transport.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="text-amber-400 text-xl">📞</span>
                            <span><strong>24/7 Operations Center:</strong> Always online — ready when every second
                                counts.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        hospitals & private clients worldwide.
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-black text-white py-24 px-6 md:px-16">
            <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative group">
                    ...
                    <div
                        class="absolute bottom-4 left-4 bg-black/70 border border-amber-500/40 rounded-xl px-4 py-2 backdrop-blur-sm">
                        <span class="text-amber-400 font-semibold">Trusted Air Evacuation</span>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    <h2 class="text-5xl md:text-6xl font-extrabold leading-tight">
                        <span class="text-amber-400">Elite</span> Medical Air Services <br />
                        <span class="text-neutral-400">When Every Second Counts</span>
                    </h2>

                    <p class="text-neutral-400 text-lg leading-relaxed max-w-lg">
                        We specialize in global air ambulance operations — moving patients safely and swiftly
                        across borders with state-of-the-art aircraft and expert medical teams.
                        Our service bridges urgency with precision.
                    </p>
